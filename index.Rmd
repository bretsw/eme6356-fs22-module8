...
[bretsw.com/eme6356-fs22-module8](https://bretsw.com/eme6356-fs22-module8)
...
# `r fa("fas fa-comment-dots", fill = "#fff")` <br><br> Module 7 Discussion <br> Final Thoughts?
...
(See the [course syllabus](https://canvas.fsu.edu/courses/207638/assignments/syllabus))
...
- **Module 8:** Case Discussions - **module ends December 4**
...
- Analytics Ethics Statement (100 points) - **due December 4**
